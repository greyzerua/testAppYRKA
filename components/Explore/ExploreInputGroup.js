...
export const ExploreInputGroup = () => {
    ...
    return (
        <Pressable onPress={() => createNewChat('newChat', 'New Chat', getWelcomeMessage('AI assistant') )} className='flex-row justify-center items-center pl-4 pr-4 pt-4 pb-3.5  '>
            <View
                className=
            ...
            <View pointerEvents='none' style={{borderRadius: 13, boxShadow: '0 0px 8px 0px rgba(92, 52, 178, 0.7)'}}>
                <LinearGradient
                    colors={['#59B0FF', '#925FFF']}
                    start={{ x: 1, y: 0 }}
                    end={{ x: 1, y: 1 }}
                    className="rounded-[13px] p-[1px] min-w-[302px]  "
